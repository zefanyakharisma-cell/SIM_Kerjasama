...
-- kepala_unit marks the head a Disposisi Evaluasi is routed to (Revisi V7 §5).
insert into jabatan (nama, id_unit, tier_disposisi, kepala_unit) values
  ('Kepala Kantor Kerja Sama dan Urusan Internasional', 2, 1, true),    -- 1
  ('Kepala Bagian Sekretariat Rektorat', 3, 1, true),                   -- 2
  ('Dekan School of Business and Management', 4, 2, true),              -- 3
  ('Kepala Program Studi Manajemen', 5, null, false),                   -- 4 (submit-only, not an approver)
  ('Wakil Rektor Bidang Akademik', 1, 3, false),                        -- 5
  ('Rektor', 1, 3, false),                                              -- 6
  ('Staf Kantor Kerja Sama', 2, null, false),                           -- 7
  ('Pimpinan Yayasan (Viewer)', 1, null, false),                        -- 8
  ('Direktur Kantor Kerja Sama dan Urusan Internasional', 2, null, false); -- 9
...
insert into akun (id_jabatan, email, role) values
  ...
  (7, 'staf-kui@petra.ac.id',              'io_admin'),   -- every KUI account is admin (V7 §1)
  (8, 'viewer@petra.ac.id',                'viewer'),
  (9, 'direktur-kui@petra.ac.id',          'io_admin');
